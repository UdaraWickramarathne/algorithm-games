        ...
        {timings.map((t) => (
          <div key={t.algorithmName}>
            ...
            <div style={{ height: '6px', background: '#1e2236', borderRadius: '3px', overflow: 'hidden' }}>
              <div style={{ height: '100%', width: `${Math.max(2, (t.executionTimeMs / max) * 100)}%`, background: `linear-gradient(90deg, ${ACCENT}, ${ACCENT}80)`, borderRadius: '3px', transition: 'width 0.8s ease' }} />
            </div>
